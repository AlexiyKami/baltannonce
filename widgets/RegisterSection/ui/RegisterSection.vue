...
const setLocations = (value) => {
  if (locations.value.includes(value)) {
    locations.value = locations.value.filter((location) => location !== value);
  } else {
      ...
      <div class="register__body">
        ...
        <form class="register__form" novalidate @submit.prevent="sendForm">
          ...
          <div class="register__locations-container">
            <h2 class="register__form-title heading_h3">Выберите город</h2>
            <RegisterLocations
              title="Литва"
