...
<template>
  <div
    class="header__login-popup login-popup-header"
    :class="{
      active: isLoginPopupOpened
    }"
  >
    <form class="login-popup-header__form" novalidate>
      <div class="login-popup-header__inputs-container">
        <div class="login-popup-header__inputs">
          <div class="login-popup-header__input-container">
            <input
              class="login-popup-header__input login-popup-header__input-email"
              type="email"
              placeholder="Email"
            >
          </div>
          <div class="login-popup-header__input-container">
            <input
              class="login-popup-header__input login-popup-header__input-password"
              type="password"
              placeholder="Пароль"
            >
            <svg
              ...
              class="login-popup-header__input-password-icon"
            >
              <path
      ...
      <div class="login-popup-header__actions-container">
        <button class="button button_primary login-popup-header__button">Войти</button>
