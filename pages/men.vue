<script setup>
import { ExtendedFilterModal } from '@/entities/Men';
</script>
      ...
      <div class="home__container _container">
        <div class="home__tab-menu">
          <div class="home__tabs-btns">
            <div class="home__tab-btn home__tab-btn_strippers">
              <h2 class="home__tab-title">
                Стриптизеры
                <span class="home__title-counter">(10)</span>
              </h2>
            </div>
            <div class="home__tab-btn home__tab-btn_escort active">
              <h2 class="home__tab-title">
                Эскорт
                <span class="home__title-counter">(12)</span>
                <svg
                  width="25"
                  height="25"
                  viewBox="0 0 25 25"
                ...
                >
                  ...
                  <path
                    ...
                    stroke-linecap="round"
                    stroke-linejoin="round"
                    class="home__title-icon-text"
                  />
                </svg>
              </h2>
            </div>
          </div>
          <div class="home__all-cards home__cards-in-tab home__cards-in-tab_strippers">
              ...
              <li class="card-background card-background_gold">
                <div class="home__card card-home">
                  <div class="card-home__badges">
                    <div class="card-home__of-the-day heading_h4">Мужчина дня!</div>
          ...
          <div class="home__all-cards home__cards-in-tab home__cards-in-tab_escort active">
            <ul class="home__cards-container">
              <li class="card-background card-background_silver">
                <div class="home__card card-home">
                  <div class="card-home__badges">
