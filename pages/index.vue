...
import '../assets/scss/widgets/home-section.scss';
      ...
      <div class="hero__container _container">
        ...
        <div class="hero__filter-btns">
          <div
            ...
            @click="isCityMenuOpened = !isCityMenuOpened"
          >
          ...
          <div
            ...
            :class="{ active: isFilterMenuOpened }"
          ...
          <div
            ...
            :class="{ active: isFilterModalMenuOpened }"
            @click="isFilterModalMenuOpened = !isFilterModalMenuOpened"
          >
            <span class="button__text">Продвинутый поиск</span>
          </div>
        </div>
        <CityDropdown :is-city-menu-opened="isCityMenuOpened" />
        <FilterDropdown :is-filter-menu-opened="isFilterMenuOpened" />
        <Transition>
          <ExtendedFilterModal
            :is-filter-modal-menu-opened="isFilterModalMenuOpened"
            @set-is-filter-modal-menu-opened="setIsFilterModalMenuOpened"
          />
        </Transition>
      </div>
    </section>
        ...
        <div class="home__all-cards">
          ...
          <div class="home__coming-soon-cards">
            <div class="home__heading">
              <h2 class="home__title">
                Скоро в городе
                <span class="home__title-counter">(5)</span>
              </h2>
            </div>
            <div class="home__cards-container">
              <div class="home__card card-home">
          ...
          <div class="home__random-cards">
            <div class="home__heading">
              <h2 class="home__title">
                Кошки в мешке
                <span class="home__title-counter">(6)</span>
              </h2>
            </div>
            <div class="home__cards-container">
              <div class="home__card card-home">
